...
export default function selectTypePokemon() {
  ...
  async function showPokemonData(pokemon) {
    ...
    let pokemonImageSearched = data.sprites.other["official-artwork"]["front_default"];
    if(pokemonImageSearched==null){
    pokemonImageSearched=data.sprites.other.home.front_default
    }
    else if(pokemonImageSearched==null){

      pokemonImageSearched=data.sprites.other.dream_world.front_default
    }
